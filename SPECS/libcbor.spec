...
%changelog
* Mon Aug 31 2026 Lucas Ravagnier <lucas.ravagnier@vates.tech> - 0.11.0-3.1
- First import of libcbor 0.11.0.3
- XCP-ng do not have the required packages to build the documentation, and even with
  Doxygen installed it would still not be sufficient.
